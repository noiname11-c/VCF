...
class CIRA(nn.Module):  # Cross Attention Fusion Module
    def __init__(self, in_channels=128):
        super(CIRA, self).__init__()
        ...
        self.avg1 = nn.Conv2d(in_channels, in_channels // 2, 1, stride=1, padding=0)
        self.avg2 = nn.Conv2d(in_channels, in_channels // 2, 1, stride=1, padding=0)
        self.max1 = nn.Conv2d(in_channels, in_channels // 2, 1, stride=1, padding=0)
        self.max2 = nn.Conv2d(in_channels, in_channels // 2, 1, stride=1, padding=0)

        self.avg11 = nn.Conv2d(in_channels // 2, in_channels, 1, stride=1, padding=0)
        self.avg22 = nn.Conv2d(in_channels // 2, in_channels, 1, stride=1, padding=0)
        self.max11 = nn.Conv2d(in_channels // 2, in_channels, 1, stride=1, padding=0)
        self.max22 = nn.Conv2d(in_channels // 2, in_channels, 1, stride=1, padding=0)
...
class LinAngularXCA_CA(nn.Module):
    ...
    def forward(self, x):
        ...
        result1, result2 = self.cira(la1, xa1)
